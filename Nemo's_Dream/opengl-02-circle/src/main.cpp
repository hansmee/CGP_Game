...
std::vector<vertex> create_circle_vertices(uint N)
{
	...
	v.push_back({ vec3(0.5f, 0.5f, 0), vec3(0.5f, 0.5f, 0), vec2(1.0f, 1.0f) });
	v.push_back({ vec3(0.5f, -0.5f, 0), vec3(0.5f, -0.5f, 0), vec2(1.0f, 0) });
	v.push_back({ vec3(-0.5f, -0.5f, 0), vec3(-0.5f, -0.5f, 0), vec2(0, 0) });
	v.push_back({ vec3(-0.5f, 0.5f, 0), vec3(-0.5f, 0.5f, 0), vec2(0, 1.0f) });
